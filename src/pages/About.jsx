...
export default function About() {
  return (
    <section id="tentang" className="bg-aspal-800 py-24 md:py-32">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-5">
            <p className="eyebrow mb-6">Kenapa kami ada</p>
            <h2 className="judul-besar text-judul-1 text-beton-050">
              Bisnis parkir
              <br className="hidden sm:block" />
              tidak harus
              <br className="hidden sm:block" />
              <span className="text-sinyal-amber">seperti dulu</span>
            </h2>
          </div>

          <div className="lg:col-span-7">
            <p className="text-lg md:text-xl text-beton-050 leading-relaxed mb-6">
            ...
            <p className="text-lg text-beton-300 leading-relaxed mb-12">
            ...
            <dl className="border-t border-aspal-700">
              {KOMITMEN.map((k) => (
                <div
                  key={k.judul}
                  className="py-6 border-b border-aspal-700 grid md:grid-cols-[1.5rem_1fr] gap-x-6 gap-y-2"
                >
                  <div
                    className="hidden md:block w-2 h-2 bg-sinyal-amber mt-2.5 rounded-full"
                    aria-hidden="true"
                  />
                  <div>
                    <dt className="judul text-lg text-beton-050 mb-2">
                      {k.judul}
                    </dt>
                    <dd className="text-beton-300 leading-relaxed">{k.isi}</dd>
                  </div>
                </div>
              ))}
            </dl>
